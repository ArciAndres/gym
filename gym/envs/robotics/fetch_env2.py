...
from gym.envs.robotics import rotations, robot_env, utils2
...
class FetchEnv2(robot_env.RobotEnv):
    ...
    def _env_setup(self, initial_qpos):
        ...
        gripper_target = np.array([0, 0, 0 ]) #+ self.sim.data.get_site_xpos('robot0:grip')
    ...
    def render(self, mode='human', width=500, height=500):
        return super(FetchEnv2, self).render(mode, width, height)
